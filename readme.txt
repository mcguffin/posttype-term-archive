...
You can can either go into the Support forum, or in the [PostType Term Archive Repository](https://github.com/mcguffin/posttype-term-archive).

= I'd like to suggest a feature. Where should I post it? =

I personally prefer GitHub. The plugin code is here: [GitHub](https://github.com/mcguffin/posttype-term-archive)
(See above as well.)
...
3. type `git clone git@github.com:mcguffin/posttype-term-archive.git`
...
Either post it on the [GitHub-repo](https://github.com/mcguffin/posttype-term-archive) or—if you cloned the repository—send me a pull request.
